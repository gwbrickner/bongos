/* EFI_SIMPLE_TEXT_OUTPUT_PROTOCOL, UEFI Spec §12.4. Used for SystemTable->ConOut / StdErr. */
...
/* EFI_SIMPLE_TEXT_INPUT_PROTOCOL, §12.3. Only referenced through SystemTable->ConIn's pointer
 * type for now; the loader doesn't read input until the M1.4 boot menu. */
